...
#+KEYWORDS: browser, automation, tool, bookmarklet, javascript, js
#+STARTUP: content 
...
executable Javascript apps to peform browser automation tasks.

You can run this app by accessing the hyperlink: 

 - http://narretz.github.io/bookmarklet-maker
...
#+BEGIN_SRC js 
window.open("http://www.mdn.org")
#+END_SRC

**** URL manipulation 

URL Manipulation is useful to send the current URL to some web service
or Web App such as Google Drive or Web Archive.
